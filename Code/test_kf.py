...
class TestKF(unittest.TestCase):
    ...
    def test_after_calling_predict_increases_state_uncertainly(self):
        x = 0.2
        v = 2.3
        ...
        # self.assertEqual(kf.mean.shape, (2, ))  #  1 boyutlu vektor old. icin

    def test_calling_update_decreases_state_uncertainly(self):
        x = 0.2
        v = 2.3
